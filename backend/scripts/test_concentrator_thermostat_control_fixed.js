...
class ConcentratorThermostatControlTest {
  ...
  async mockControlCommand(deviceId, commandType, settings, user) {
    ...
    if (device.configuration) {
      commandConfig = device.configuration;
    } else {
    ...
    } else if (commandConfig.command_config && commandConfig.command_config.commands) {
      commands = commandConfig.command_config.commands;
    } else {
