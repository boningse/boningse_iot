...
class ThermostatController {
  ...
  async getGroups(req, res) {
    try {
      const tenantId = getTenantScope(req);
      const groups = await thermostatService.getGroups(tenantId);
  ...
  async createGroup(req, res) {
    try {
      ...
      const group = await thermostatService.createGroup({ name, description }, tenantId);
  ...
  async updateGroup(req, res) {
    try {
      ...
      const group = await thermostatService.updateGroup(groupId, { name, description }, tenantId);
  ...
  async deleteGroup(req, res) {
    try {
      ...
      const result = await thermostatService.deleteGroup(groupId, tenantId);
  ...
  async addDeviceToGroup(req, res) {
    try {
      ...
      const result = await thermostatService.addDeviceToGroup(groupId, deviceIds, tenantId);
  ...
  async removeDeviceFromGroup(req, res) {
    try {
      ...
      const result = await thermostatService.removeDeviceFromGroup(groupId, deviceId, tenantId);
